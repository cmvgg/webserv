...
static std::string	getPageContent(std::string code)
{
	...
	content += "\n\t\t<a href=\"https://github.com/cmvgg/webserv.git\"><i class=\"fab fa-github\"></i><span class=\"tabname\">Source</span></a>";
	content += "\n\t</span>\n</header>\n\n<body>\n<div class=\"vertical\">";
	content += "\n\t<center>\n\t<h6 class=\"title404_1\">";
	content += code;
	content += "</h6><br><br><br>\n\t<h6 class=\"title404_2\">";
	...
	content += "\n</div>\n</body>\n\n<footer>\n\t<ul class=\"footer\">\n\t\t<li></li>";
	content += "\n\t\t<li><a href=\"https://github.com/AlRodriguezGar14\" target=\"_blank\"><i class=\"fab fa-github\"></i> alberrod</a></li>";
	content += "\n\t\t<li><a href=\"https://github.com/cmvgg\" target=\"_blank\"><i class=\"fab fa-github\"></i> cvarela-</a></li>";
	content += "\n\t\t<li></li>\n\t</ul>\n</footer>\n</html>\n";
...
int	defaultPageSend(int fde, HTTPResponse &response)
{
	...
	if (LOG_LEVEL >= LVL_INFO)
		std::cout << "[Sending] default error page to " << fde << std::endl;
...
int	autoindexPageSend(int fde, HTTPResponse &response, std::string path, std::string root)
{
	...
	if (LOG_LEVEL >= LVL_INFO)
		std::cout << "[Sending] autoindex page to " << fde << std::endl;
	if (LOG_LEVEL >= LVL_RESPONSE)
	{
		std::cout << std::endl << "<----------- Response ----------->" << std::endl;
		std::cout << header  << std::endl << std::endl;
